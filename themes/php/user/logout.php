...
<?php
setcookie("username", "", time()-3600, "/", "nachhilfe.staddi99.ovh");
setcookie("password", "", time()-3600, "/", "nachhilfe.staddi99.ovh");

setcookie("message", "<div class=\"alert alert-success\" role=\"alert\">Sie wurden erfolgreich abgemeldet!</div>", time()+60, "/", "nachhilfe.staddi99.ovh");
header('Location: /');
?>